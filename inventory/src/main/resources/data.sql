...
insert into product (name, type, category_id, active) values ('Cadeira de madeira', 'PHYSICAL', 2, true);
insert into product (name, type, category_id, active) values ('Mesa com tampo de vidro', 'PHYSICAL', 2, true);
insert into product (name, type, category_id, active) values ('Montagem de móveis', 'SERVICE', 3, true);
